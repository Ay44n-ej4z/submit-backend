...
router.post("/", auth, async (req, res) => {
  ...
  const { name, author, isComplete, date, uid, time, dates } = req.body;

  let todo = new Todo({ name, author, isComplete, date, uid, time, dates });
...
router.put("/:id", auth, async (req, res) => {
  ...
  const updatedTodo = await Todo.findByIdAndUpdate(
    req.params.id,
    { name, author, isComplete, date, uid, time, dates },
    { new: true }
  );
